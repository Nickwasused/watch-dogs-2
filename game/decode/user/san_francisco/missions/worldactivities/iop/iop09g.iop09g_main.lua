...
function export:Init(cbox)
  ...
  l0.Started = DummyFunction
  l0.Finished = DummyFunction
  self[141] = cbox:CreateBox("domino/System/Timer_v2.lua")
  l0 = self[141]
  l0._graph = self
  l0.Out = DummyFunction
  l0.Started = DummyFunction
  ...
  l0.TimeElapsed = self.f_141_TimeElapsed
  ...
  l0.LoopingEnded = DummyFunction
  l0.GotTime = DummyFunction
  self[51] = cbox:CreateBox("domino/System/IOPController.lua")
  l0 = self[51]
  l0._graph = self
  l0.Out = DummyFunction
  l0.StartCompleted = DummyFunction
  ...
  l0.StopEmptyRoomCompleted = DummyFunction
  l0.EndForced = DummyFunction
  l0.SendEventCompleted = self.f_51_SendEventCompleted
  l0.IOPKickOutComplete = DummyFunction
  ...
  l0.NoTextSet = DummyFunction
  l0.OverrideHackingTextSet = DummyFunction
  self[64] = cbox:CreateBox("domino/Library/common/IOP.IOP_CleanUp.lua")
  l0 = self[64]
  l0._graph = self
  l0.Completed = self.f_64_Completed
  l0.DisconnectedAnimationPlayed = self.f_64_DisconnectedAnimationPlayed
  l0.Out = DummyFunction
  ...
  l0.IOPKickOutComplete = DummyFunction
  self[157] = cbox:CreateBox("domino/System/HackableController_v2.lua")
  l0 = self[157]
  l0._graph = self
  l0.Enabled = DummyFunction
  ...
  self[83] = cbox:CreateBox("domino/Library/common/IOP.IOP_StartUp.lua")
  l0 = self[83]
  l0._graph = self
...
function export:f_51_SendEventCompleted()
  local l0
  self = self._graph
  l0 = self[50]
  l0:Condition(0)
...
function export:f_64_Completed()
  local l0
  self = self._graph
  l0 = self[141]
  l0:Start()
end
function export:f_64_DisconnectedAnimationPlayed()
  local l0
  self = self._graph
  self:en_148()
  l0 = self[148]
