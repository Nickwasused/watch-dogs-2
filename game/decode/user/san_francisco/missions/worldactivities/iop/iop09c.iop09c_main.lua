...
function export:Init(cbox)
  ...
  l0.MessageCompleted = self.f_146_MessageCompleted
  ...
  l0.Finished = DummyFunction
  self[150] = cbox:CreateBox("domino/System/MissionMessageController_v3.lua")
  l0 = self[150]
  l0._graph = self
  ...
  l0.IOPKickOutComplete = DummyFunction
  self[4] = cbox:CreateBox("domino/System/IOPController.lua")
  l0 = self[4]
  l0._graph = self
  l0.Out = DummyFunction
  l0.StartCompleted = DummyFunction
  ...
  l0.StopEmptyRoomCompleted = DummyFunction
  l0.EndForced = DummyFunction
  l0.SendEventCompleted = self.f_4_SendEventCompleted
  l0.IOPKickOutComplete = DummyFunction
  self[7] = cbox:CreateBox("domino/System/RewardComponentController_V3.lua")
  l0 = self[7]
  l0._graph = self
  l0.Out = self.f_7_Out
  l0.RewardsCleaned = DummyFunction
  ...
  l0.Paused = self.f_22_Paused
  l0.Resumed = self.f_22_Resumed
  l0.TimeElapsed = self.f_22_TimeElapsed
  l0.LoopingEnded = self.f_22_LoopingEnded
  l0.GotTime = DummyFunction
  ...
  l0.StopEmptyRoomCompleted = DummyFunction
  l0.EndForced = DummyFunction
  l0.SendEventCompleted = self.f_23_SendEventCompleted
  l0.IOPKickOutComplete = DummyFunction
  ...
  l0.RewardsRegistered = DummyFunction
  l0.RewardsExecuted = DummyFunction
  self[160] = cbox:CreateBox("domino/System/SecurityCameraMonitor.lua")
  l0 = self[160]
  l0._graph = self
  l0.Enabled = DummyFunction
  l0.Disabled = self.f_160_Disabled
  l0.OnStartAccessCamera = DummyFunction
  l0.OnEndAccessCamera = self.f_160_OnEndAccessCamera
  ...
  l0.Out = DummyFunction
  self[154] = cbox:CreateBox("domino/System/MultipleOR.lua")
  l0 = self[154]
  l0._graph = self
  l0._DynamicAnchors = {Input = 2}
...
function export:f_146_MessageCompleted()
  local l0
  self = self._graph
...
function export:f_4_SendEventCompleted()
  local l0
  self = self._graph
  l0 = Boxes[PathID("domino/System/CompareBoolean_v2.lua")]
  l0.A = self.Alarm
...
function export:f_39_A_gt_B()
  ...
  l0._graph = self
  l0.Out = DummyFunction
  l0.A_lt_B = self.f_2_A_lt_B
  l0.A_le_B = DummyFunction
  l0.A_eq_B = self.f_2_A_eq_B
  l0.A_ge_B = DummyFunction
...
function export:f_22_LoopingEnded()
  local l0, l1
  self = self._graph
  l0 = self[22]
  l1 = self[81]
...
function export:f_23_SendEventCompleted()
  local l0
  self = self._graph
  l0 = self[21]
  l0:Input(5)
...
function export:f_160_Disabled()
  local l0
  self = self._graph
  l0 = self[159]
  l0.Seconds = 0.5
...
function export:f_160_OnEndAccessCamera()
  local l0
  self = self._graph
  self:en_160()
  l0 = self[160]
