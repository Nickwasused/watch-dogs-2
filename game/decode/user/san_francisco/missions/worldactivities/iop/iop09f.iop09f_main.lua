...
function export:Init(cbox)
  ...
  l0.IOPKickOutComplete = DummyFunction
  self[162] = cbox:CreateBox("domino/System/SecurityCameraMonitor.lua")
  l0 = self[162]
  l0._graph = self
  l0.Enabled = DummyFunction
  l0.Disabled = self.f_162_Disabled
  l0.OnStartAccessCamera = DummyFunction
  l0.OnEndAccessCamera = self.f_162_OnEndAccessCamera
  ...
  l0.Resumed = self.f_15_Resumed
  l0.TimeElapsed = self.f_15_TimeElapsed
  l0.LoopingEnded = self.f_15_LoopingEnded
  l0.GotTime = DummyFunction
  ...
  l0.StopEmptyRoomCompleted = DummyFunction
  l0.EndForced = DummyFunction
  l0.SendEventCompleted = self.f_64_SendEventCompleted
  l0.IOPKickOutComplete = DummyFunction
  ...
  l0.StopEmptyRoomCompleted = DummyFunction
  l0.EndForced = DummyFunction
  l0.SendEventCompleted = self.f_12_SendEventCompleted
  l0.IOPKickOutComplete = DummyFunction
  ...
  self[50] = cbox:CreateBox("domino/Library/common/IOP.IOP_StartUp.lua")
  l0 = self[50]
  l0._graph = self
  ...
  self[157] = cbox:CreateBox("domino/System/IOPPropMonitor.lua")
  l0 = self[157]
  l0._graph = self
  l0.Out = DummyFunction
  l0.Enabled = self.f_157_Enabled
  l0.Disabled = DummyFunction
  l0.PropSpawned = self.f_157_PropSpawned
  ...
  self[2] = cbox:CreateBox("domino/Library/common/IOP.IOP_CleanUp.lua")
  l0 = self[2]
  l0._graph = self
  l0.Completed = self.f_2_Completed
  l0.DisconnectedAnimationPlayed = self.f_2_DisconnectedAnimationPlayed
  l0.Out = DummyFunction
  ...
  l0.IOPKickOutComplete = DummyFunction
  self[155] = cbox:CreateBox("domino/System/HackableController_v2.lua")
  l0 = self[155]
  l0._graph = self
  l0.Enabled = DummyFunction
  ...
  l0.ProfileReset = DummyFunction
  l0.ProfilingEnabled = DummyFunction
  l0.ProfilingDisabled = self.f_155_ProfilingDisabled
  l0.OccludableSet = DummyFunction
  l0.HackForced = DummyFunction
  l0.NoTextSet = DummyFunction
  l0.OverrideHackingTextSet = DummyFunction
...
function export:f_162_OnEndAccessCamera()
  local l0
  self = self._graph
  self:en_162()
  l0 = self[162]
...
function export:f_15_LoopingEnded()
  local l0, l1
  self = self._graph
  l0 = self[15]
  l1 = self[37]
...
function export:f_64_SendEventCompleted()
  local l0
  self = self._graph
  l0 = self[51]
  l0:Condition(0)
...
function export:f_121_A_gt_B()
  ...
  l0._graph = self
  l0.Out = DummyFunction
  l0.A_lt_B = self.f_13_A_lt_B
  l0.A_le_B = DummyFunction
  l0.A_eq_B = self.f_13_A_eq_B
  l0.A_ge_B = DummyFunction
  l0.A_gt_B = self.f_13_A_gt_B
  l0.A_ne_B = DummyFunction
  l0:In()
end
...
function export:f_12_SendEventCompleted()
  local l0
  self = self._graph
  l0 = self[160]
  l0:Start()
...
function export:f_158_ByIndexReset()
  local l0
  self = self._graph
  self:en_157()
  l0 = self[157]
...
function export:f_157_PropSpawned()
  local l0, l1
  self = self._graph
  l0 = self[157]
  ...
  l1.ByIndexReset = self.f_158_ByIndexReset
...
function export:f_2_Completed()
  local l0
  self = self._graph
  l0 = self[83]
  l0:Start()
end
function export:f_2_DisconnectedAnimationPlayed()
  local l0
  self = self._graph
  self:en_148()
  l0 = self[148]
...
function export:f_155_ProfilingDisabled()
  local l0
  self = self._graph
  self:en_154()
  l0 = self[154]
