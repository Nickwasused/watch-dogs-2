...
function export:Init(cbox)
  ...
  l0.AbortMoveAndUseSeat = self.f_8_AbortMoveAndUseSeat
  ...
  l0.UnassignCompleted = DummyFunction
  l0.AbortMoveAndUseSeat = self.f_9_AbortMoveAndUseSeat
  l0.Out = DummyFunction
...
function export:f_8_AbortMoveAndUseSeat()
  local l0
  self = self._graph
  l0 = self[12]
  l0:In(1)
...
function export:f_9_AbortMoveAndUseSeat()
  local l0
  self = self._graph
  l0 = self[13]
  l0:In(1)
