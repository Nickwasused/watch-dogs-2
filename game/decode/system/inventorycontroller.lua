...
function InventoryController:SwitchLocalPlayerInventoryToNormal()
  ...
  SwitchLocalPlayerInventory("Normal")
  Out(self)
  Switched(self)
end
function InventoryController:SwitchLocalPlayerInventoryToEmpty()
  local Out = self.Out
  local Switched = self.Switched
  SwitchLocalPlayerInventory("Empty")
  Out(self)
  Switched(self)
end
function InventoryController:SwitchLocalPlayerInventory()
  local Out = self.Out
  local Switched = self.Switched
  if LuaLibCore:AssertNotNil(self.Loadout, "Loadout") then
    SwitchLocalPlayerInventory(self.Loadout)
  end
  Out(self)
  Switched(self)
end
